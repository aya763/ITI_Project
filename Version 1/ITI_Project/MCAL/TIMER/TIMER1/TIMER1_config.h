...
#define TIMER1_MODE                     TIMER1_FAST_PWM_TOP_ICR1    //TIMER1_NORMAL //

#define TIMER1_OC1A_B_PIN_STATE         TIMER1_FAST_PWM_CLEAR_CTC_SET_BOTTOM  // TIMER1_NORMAL_DISCONNECT_OC1A_B  //
